...
import com.example.libraryseatreservation.base.BaseViewModel
import com.example.libraryseatreservation.bean.CountChange
import com.example.libraryseatreservation.bean.LoginAutoCode
import com.example.libraryseatreservation.bean.LoginFormState
import com.example.libraryseatreservation.bean.LoginResult
import com.example.libraryseatreservation.repository.bMobSMS
import com.example.libraryseatreservation.repository.bMobSMSVerify
import com.example.libraryseatreservation.util.isValidPassword
import com.example.libraryseatreservation.util.isValidPhoneNumber
/**
 * author : hasyo
 * time : 2023/3/17
 * 登录组件对应的ViewModel
